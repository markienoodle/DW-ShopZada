...
CREATE TABLE IF NOT EXISTS staging2_schema.order_data_stg2 (
    order_id          VARCHAR(36),
...
TRUNCATE TABLE staging2_schema.order_data_stg2;
...
WITH ranked AS (
    ...
    FROM staging1_schema.order_data_cleaned_raw r
),
grouped AS (
...
INSERT INTO staging2_schema.order_data_stg2 (
    order_id,
    campaign_id,
    user_id,
    merchant_id,
